...
export interface ApiAuthorAuthor extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    biography: Attribute.Text & Attribute.Required;
...
export interface ApiBookBook extends Schema.CollectionType {
  ...
  attributes: {
    ...
    category: Attribute.Enumeration<
      ['fantasy', 'thriller', 'comics', 'biography']
    >;
    currentOwner: Attribute.Relation<
      'api::book.book',
      'oneToOne',
      'api::loan.loan'
    >;
...
export interface ApiLoanLoan extends Schema.CollectionType {
  ...
  attributes: {
    ...
    returned: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    book: Attribute.Relation<'api::loan.loan', 'oneToOne', 'api::book.book'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
