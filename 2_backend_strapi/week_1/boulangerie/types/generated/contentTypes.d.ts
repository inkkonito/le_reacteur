...
export interface ApiBeverageBeverage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    category: Attribute.Enumeration<['water', 'soda', 'alcool']> &
      Attribute.DefaultTo<'water'>;
    quantity: Attribute.Integer & Attribute.DefaultTo<1>;
    volume: Attribute.Integer & Attribute.DefaultTo<33>;
    price: Attribute.Decimal & Attribute.DefaultTo<3>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
