...
<template>
  ...
  <div v-else class="h-full py-[30px] mx-auto">
    <div class="flex gap-[20px]">
      ...
      <div class="w-2/3">
        ...
        <h2
          class="mb-[25px] mt-[50px] border-t-[1px] border-t-lbc_grey_med pt-[20px] text-[18px] font-bold"
        >
          Description
        </h2>
        <p>{{ offerInfos.attributes.description }}</p>
        <p
          class="mb-[25px] mt-[50px] border-t-[1px] border-t-lbc_grey_med pt-[20px]"
        >
          <font-awesome-icon
      ...
      <!-- Second column -->
      <div
        class="flex h-[375px] w-1/3 flex-col justify-between rounded-[2px] p-[20px] shadow-md shadow-lbc_grey_med"
      >
        <!-- owner -->
        <div class="flex flex-col gap-[20px]">
          ...
          <p
            class="self-start rounded-[10px] bg-lbc_orange_pale py-[4px] px-[7px] text-[12px] text-lbc_brown"
          >
        ...
        <div class="flex flex-col gap-[10px] px-[15px] bt-[1px] border-t-lbc_grey_med">
          <a href="" class="bg-lbc_orange text-center border-none text-white p-[15px] rounded-[15px] font-bold">Acheter</a>
          <button class="bg-lbc_blue_dark text-center border-none text-white p-[15px] rounded-[15px] font-bold">Message</button>
        </div>
      </div>
    </div>
  </div>
